$(document).ready(function () {
  ...
  $("input[name='your-city']").on("change", function () {
    if ($(this).val() !== "") {
      ...
      var radioValue1 = $("input[name='your-city']:checked").val();
  ...
  $("#AffiliatesPopupForm").validate({
    ...
    submitHandler: function (form) {
      try {
        ...
        if ($("input[type=radio][name=your-city]:checked").length == 0) {
  ...
  $("#id_select2_contact").select2(options);
  $("#id_select2_popup").select2(options);
});
